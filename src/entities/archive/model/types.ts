...
export interface DocEntry {
	...
	chars: number;
	/**
	 * 진행 상태. **비어 있으면 초고다**(`statusOf`).
	 *
	 * 새 원고는 만들 때 초고가 적힌다. 비어 있는 것은 상태가 생기기 전에 쓴
	 * 원고들이고, 그것을 채우는 마이그레이션 대신 읽는 규칙으로 맞춘다.
	 */
 ...
 * 버려진 것.
 *
 * 원고는 제목과 목표와 상태를 함께 들고 간다. 되살릴 때 돌려주어야 하고, 제목은
 * 휴지통 목록에서 어느 원고인지 알아볼 유일한 단서이기도 하다. 본문과 달리 짧은
 * 값이라 색인에 두어도 무겁지 않다.
 *
